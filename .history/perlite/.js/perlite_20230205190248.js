            ...
            success: function (result) {
                if (popHover == false) {
                    ...
                    document.getElementById("mdContent").innerHTML = document
                        ...
                        .innerHTML.replace(
                            ...
                            function (str, openLevel, titleText, closeLevel) {
                                ...
                                toc +=
                                    '<div class="tree-item-self is-clickable"><a href="#' +
                                    anchor +
                                    '">' +
                                    titleText +
                                    "</a></div>";
                    ...
                    $(".frontmatter-container-header").click(function (e) {
                        ...
                        if (
                            $(".frontmatter-container").hasClass("is-collapsed")
                        ) {
                            $(".frontmatter-container").removeClass(
                                "is-collapsed"
                            );
                        } else {
                            $(".frontmatter-container").addClass(
                                "is-collapsed"
                            );
                        }
                    });
                ...
                for (var i = 0; i < mermaids.length; i++) {
                    ...
                    for (f = 0; f < mermaidLinks.length; ) {
                        ...
                        if (
                            linkElement.getAttribute("href").startsWith("?link")
                        ) {
...
function renderGraph(modal, path = "", filter_emptyNodes = false) {
    ...
    var options = {
        ...
        edges: {
            ...
            color: getComputedStyle(
                document.querySelector(".graph-view.color-line")
            ).color,
            smooth: {
                type: varGraphStyle,
                enabled: true,
        ...
        nodes: {
            ...
            font: {
                size: 16,
                color: getComputedStyle(
                    document.querySelector(".graph-view.color-text")
                ).color,
            },
            borderWidth: 1,
            color: {
                background: getComputedStyle(
                    document.querySelector(".graph-view.color-fill")
                ).color,
    ...
    if (modal) {
        ...
        node.setOptions({
            ...
            color: {
                background: getComputedStyle(
                    document.querySelector(".graph-view.color-fill-focused")
                ).color,
            },
        });
                ...
                for (const x in jsonNodes) {
                    if (jsonEdges[y]["to"] == jsonNodes[x]["id"]) {
                        if (!idExists(jsonNodes[x]["id"])) {
                            jsonNodes[x]["label"] = jsonNodes[x][
                                "label"
                            ].replace("&amp;", "&");
                            jsonNodes[x]["title"] = jsonNodes[x][
                                "title"
                            ].replace("&amp;", "&");
                            myNodes.push(jsonNodes[x]);
                        }
    ...
    if ($(window).width() < 990) {
        ...
        if ($(".popUpSetting").hasClass("is-enabled")) {
            $(".internal-link").click(function (e) {
                ...
                $(".goToLink").html(
                    '<a href="' + this.href + '"> go to site</a><br><br>'
                );
            });
        }
    }
...
function search(str) {
    if (str.length == 0) {
        ...
        $.ajax({
            url: "content.php?search=" + str,
            success: function (result) {
                $("div.search-results-children").html(result);
                let preCodes = $("div.search-results-children").find(
                    "pre code"
                );
...
function toggleNavFolder(e) {
    ...
    if (el.hasClass("nav-folder-title")) {
        ...
        el.hasClass("nav-folder-collapse-indicator collapse-icon") ||
        el.hasClass("nav-folder-title-content")
    ) {
        el = el.parent().parent();
...
function openNavMenu(target, openAll = false) {
    ...
    $("div")
        ...
        .parent()
        .addClass("perlite-link-active is-active");
}
...
$(document).ready(function () {
    ...
    if (localStorage.getItem("Font_size")) {
        $("body").css(
            "--font-text-size",
            localStorage.getItem("Font_size") + "px"
        );
    }
    ...
    if (localStorage.getItem("Graph_LinkDistance")) {
        $(".slider.linkDistance").val(
            localStorage.getItem("Graph_LinkDistance")
        );
    } else {
    ...
    if (localStorage.getItem("Graph_LinkThickness")) {
        $(".slider.linkThickness").val(
            localStorage.getItem("Graph_LinkThickness")
        );
    } else {
    ...
    if (localStorage.getItem("leftSizePanel")) {
        $(".workspace-split.mod-horizontal.mod-left-split").css(
            "width",
            localStorage.getItem("leftSizePanel")
        );
    }

    if (localStorage.getItem("rightSizePanel")) {
        $(".workspace-split.mod-horizontal.mod-right-split").css(
            "width",
            localStorage.getItem("rightSizePanel")
        );
    }
    ...
    if ($("#allGraphNodes").length == 0 || $("#allGraphNodes").text == "[]") {
        $(
            '.clickable-icon.side-dock-ribbon-action[aria-label="Open graph view"]'
        ).css("display", "none");
        $('.clickable-icon.view-action[aria-label="Open outline"]').css(
            "display",
            "none"
        );
        $('.clickable-icon.view-action[aria-label="Open localGraph"]').css(
            "display",
            "none"
        );
    ...
    $(".sidebar-toggle-button.mod-left.sidebar").click(function (e) {
        ...
        if (
            $(".sidebar-toggle-button.mod-left.sidebar").hasClass(
                "is-collapsed"
            )
        ) {
            $(".workspace").addClass("is-left-sidedock-open");
    ...
    $('.workspace-tab-header[data-type="search"]').click(function (e) {
        ...
        $('.workspace-leaf-content[data-type="file-explorer"]')
            .parent()
            .css("display", "none");
        $('.workspace-tab-header[data-type="search"]').addClass(
            "is-active mod-active"
        );
        $('.workspace-tab-header[data-type="file-explorer"]').removeClass(
            "is-active mod-active"
        );
    ...
    $('.workspace-tab-header[data-type="file-explorer"]').click(function (e) {
        ...
        $('.workspace-leaf-content[data-type="search"]')
            .parent()
            .css("display", "none");
        $('.workspace-tab-header[data-type="file-explorer"]').addClass(
            "is-active mod-active"
        );
        $('.workspace-tab-header[data-type="search"]').removeClass(
            "is-active mod-active"
        );
    });

    // click expand-search-all
    $('.clickable-icon.nav-action-button[aria-label="Collapse results"]').click(
        function (e) {
            e.preventDefault();
            ...
            if ($(".tree-item.search-result").hasClass("is-collapsed")) {
                ...
                $(
                    '.clickable-icon.nav-action-button[aria-label="Collapse results"]'
    ...
    $('.clickable-icon.nav-action-button[aria-label="Expand all"]').click(
        function (e) {
            e.preventDefault();
            target = $(e.target);
            ...
            $(
                '.clickable-icon.nav-action-button[aria-label="Collapse all"]'
            ).css("display", "unset");
    ...
    $('.clickable-icon.nav-action-button[aria-label="Collapse all"]').click(
        function (e) {
            e.preventDefault();
            target = $(e.target);
            ...
            $('.clickable-icon.nav-action-button[aria-label="Expand all"]').css(
                "display",
                "unset"
            );
            target.css("display", "none");
    ...
    $('.clickable-icon[aria-label="Restore text settings"]').click(function (
        e
    ) {
        e.preventDefault();
    ...
    $('.clickable-icon[aria-label="Restore panel settings"]').click(function (
        e
    ) {
        e.preventDefault();
    ...
    $(
        ...
        if ($('.view-header-nav-buttons[data-section="close"]').is(":hidden")) {
            ...
            $('.view-header-nav-buttons[data-section="close"]').css(
                "display",
                "flex"
            );
    ...
    // open Graph settings
    $(
        '.clickable-icon.graph-controls-button.mod-open[aria-label="Open graph settings"]'
    ).click(function (e) {
        e.preventDefault();
    ...
    $(
        '.clickable-icon.graph-controls-button.mod-close[aria-label="Close"]'
    ).click(function (e) {
        e.preventDefault();
    ...
    $(
        '.clickable-icon.graph-controls-button.mod-reset[aria-label="Restore default settings"]'
    ).click(function (e) {
        e.preventDefault();
    ...
    // info modal
    $('.clickable-icon.side-dock-ribbon-action[aria-label="Help"]').click(
        function (e) {
            $.ajax({
                url: "content.php?about",
                success: function (result) {
    ...
    // setting modal
    $('.clickable-icon.side-dock-ribbon-action[aria-label="Settings"]').click(
        function (e) {
    ...
    $('.clickable-icon.view-action[aria-label="Open outline"]').click(function (
        e
    ) {
        $('.clickable-icon.view-action[aria-label="Open outline"]').css(
            "display",
    ...
    $('.clickable-icon.view-action[aria-label="Open localGraph"]').click(
        function (e) {
            $('.clickable-icon.view-action[aria-label="Open outline"]').css(
                "display",
                "unset"
